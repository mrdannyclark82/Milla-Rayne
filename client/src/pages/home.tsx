...
// The direct imports below are no longer needed, as we will use public URLs instead.
...
export default function Home() {
  ...
  const getAvatarImage = () => {
    switch (avatarState) {
      case "thinking":
        return "/images/Milla_thoughtful_expression_avatar_dbb1829b.png";
      case "responding":
        return "/images/Milla_smiling_expression_avatar_4945ceea.png";
      default:
        return "/images/Hyper-realistic_Milla_full_body_dbd5d6ca.png";
    }
  };
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="relative w-full h-full overflow-hidden">
          {use3DAvatar ? (
            ...
            <video
              src="/images/Creating_a_Living_Portrait_Animation_1756641116784.mp4"
              autoPlay
              loop
              muted
              playsInline
