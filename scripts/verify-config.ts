...
console.log(`  - getMillaPersona() returns ${getMillaPersona().length} characters`);
console.log(`  - getMillaPersonaCondensed() returns ${getMillaPersonaCondensed().length} characters`);
console.log(`  - MILLA_CORE_IDENTITY defined: ${!!MILLA_CORE_IDENTITY}`);
console.log(`  - MILLA_COMMUNICATION_PATTERNS defined: ${!!MILLA_COMMUNICATION_PATTERNS}`);

// Test Scene Settings
console.log('\n✅ Testing Scene Settings:');
console.log(`  - getAllSceneSettings() returns ${getAllSceneSettings().length} characters`);
console.log(`  - SCENE_LIVING_ROOM defined: ${!!SCENE_LIVING_ROOM}`);
console.log(`  - getSceneDetails('bedroom') returns ${getSceneDetails('bedroom').length} characters`);
console.log(`  - getContextualSceneSettings() returns ${getContextualSceneSettings().length} characters`);
...
const personaMatches = personaKeywords.filter(keyword => fullPersona.includes(keyword));
const sceneMatches = sceneKeywords.filter(keyword => allScenes.includes(keyword));

console.log(`  - Persona contains ${personaMatches.length}/${personaKeywords.length} expected keywords`);
console.log(`  - Scenes contain ${sceneMatches.length}/${sceneKeywords.length} expected keywords`);
